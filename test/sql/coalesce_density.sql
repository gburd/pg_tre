-- Posting-page coalescing DENSITY win (Blocker 1, format v8).
--
...
--   4. The ON index is at on-disk format v8 (additive; no REINDEX).
--
...
-- (4) Format v8: every page of the ON index is at format v8.
