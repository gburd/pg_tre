 ...
 *   v6     - introduced in 1.6.1-dev.  The vendored sparsemap was updated
 ...
 * As of 1.6.1-dev MIN == LATEST == 6: there is no in-place upgrade from
...
#define PG_TRE_VERSION_STRING "pg_tre 1.6.1-dev"
