 ...
 *            to 4.0.2-dev, whose serialized "wire" format widened the
 ...
 *
 *   v8     - introduced in 3.0.2 (posting-page coalescing).  Adds a
 ...
 *   must be REINDEXed -- the sparsemap 4.0.2-dev wire format is not
 ...
 * As of 3.0.2 LATEST == 8, MIN == 6: v7 adds the run/level catalog
...
#define PG_TRE_VERSION_STRING "pg_tre 4.0.2-dev"
 ...
 * bloom/payload path was removed in 3.0.2; new builds emit payload-free
