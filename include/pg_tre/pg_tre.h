 ...
 *   v6     - introduced in 2.0.3.  The vendored sparsemap was updated
 ...
 *
 *   v8     - introduced in 2.0.3 (posting-page coalescing).  Adds a
 ...
 * As of 2.0.3 LATEST == 8, MIN == 6: v7 adds the run/level catalog
...
#define PG_TRE_VERSION_STRING "pg_tre 2.0.3"
