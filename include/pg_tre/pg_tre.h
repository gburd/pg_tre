 ...
 *   v6     - introduced in 3.0.0-dev.  The vendored sparsemap was updated
 ...
 *
 *   v8     - introduced in 3.0.0-dev (posting-page coalescing).  Adds a
 ...
 * As of 3.0.0-dev LATEST == 8, MIN == 6: v7 adds the run/level catalog
...
#define PG_TRE_VERSION_STRING "pg_tre 3.0.0-dev"
