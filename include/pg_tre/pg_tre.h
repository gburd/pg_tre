 ...
 *   v6     - introduced in 1.12.0-dev.  The vendored sparsemap was updated
 ...
 * As of 1.12.0-dev MIN == LATEST == 6: there is no in-place upgrade from
...
#define PG_TRE_VERSION_STRING "pg_tre 1.12.0-dev"
