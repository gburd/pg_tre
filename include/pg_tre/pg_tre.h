 ...
 *   v6     - introduced in 2.0.0.  The vendored sparsemap was updated
 ...
 *
 *   v8     - introduced in 2.0.0 (posting-page coalescing).  Adds a
...
#define PG_TRE_VERSION_STRING "pg_tre 2.0.0"
