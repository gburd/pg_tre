-- pg_tre 3.2.5-dev -- native index AM for approximate regex matching.
--
...
-- ---------------------------------------------------------------
-- 3.0.2 (Phase A / A1): LIKE / ILIKE / ~ / ~* / = acceleration.
...
-- ---------------------------------------------------------------
-- 3.0.2: pg_trgm-compatible trigram-set similarity (Phase A / A2).
...
-- ---------------------------------------------------------------
-- 3.0.2 (Phase A / A2 remainder): word_similarity operators.
...
-- ---------------------------------------------------------------
-- 3.2.0: SuRF range-filter tier (format v10) introspection.
-- ---------------------------------------------------------------
...
COMMENT ON FUNCTION tre_surf_stats(regclass) IS
    ...
    'All zero when the index has no SuRF (built before v10, empty, or '
    'upgraded in place without REINDEX).';
