-- pg_tre 3.0.0 -- native index AM for approximate regex matching.
--
...
-- ---------------------------------------------------------------
-- 3.0.0 (Phase A / A1): LIKE / ILIKE / ~ / ~* / = acceleration.
...
-- ---------------------------------------------------------------
-- 3.0.0: pg_trgm-compatible trigram-set similarity (Phase A / A2).
...
-- ---------------------------------------------------------------
-- 3.0.0 (Phase A / A2 remainder): word_similarity operators.
