-- pg_tre 3.0.1 -- native index AM for approximate regex matching.
--
...
-- ---------------------------------------------------------------
-- 3.0.1 (Phase A / A1): LIKE / ILIKE / ~ / ~* / = acceleration.
...
-- ---------------------------------------------------------------
-- 3.0.1: pg_trgm-compatible trigram-set similarity (Phase A / A2).
...
-- ---------------------------------------------------------------
-- 3.0.1 (Phase A / A2 remainder): word_similarity operators.
